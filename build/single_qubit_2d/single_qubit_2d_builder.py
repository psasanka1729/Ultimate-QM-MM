...
#Do the git-ing
cmd='git commit -a -m "Commit before run single_qubit_2d" > /dev/null'
print(cmd)
...
open('single_qubit_2d.log','w').write(logstr)

#Setup the versionmap and qsub files
vmap_file=open('versionmap.dat','w')
vmap_file.write('vnum\tL\n')

task_file=open('single_qubit_2d.task','w')
template_file='single_qubit_2d.template'
...
open('single_qubit_2d.sbatch','w').write(contents)
